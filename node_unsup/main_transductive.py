...
from comgae.datasets.data_util import load_dataset
from comgae.evaluation import node_classification_evaluation
from comgae.models import build_model
...
def main(args):
    ...
    for i, seed in enumerate(seeds):
        ...
        final_acc, estp_acc, final_f1, estp_f1 = node_classification_evaluation(model, graph, x, num_classes, lr_f, weight_decay_f, max_epoch_f, device, linear_prob)
        acc_list.append(final_acc)
        estp_acc_list.append(estp_acc)
        f1_list.append(final_f1)
        estp_f1_list.append(estp_f1)
